The ** _dsEeprom_ ** library is a helper libs to simplify EEPROM-access (e.g. storeString, restoreString, ...) and some extended funktionality. For further information see the README in the dsEeprom subfolder.
